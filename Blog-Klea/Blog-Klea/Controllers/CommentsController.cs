...
namespace Blog_Klea.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(Blog_KleaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Content,PublicationDate,OwnerID,BlogPostId")] Comment comment)
        {
